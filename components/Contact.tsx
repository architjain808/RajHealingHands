...
const Contact: React.FC = () => {
  ...
  const clinicAddress =
    "Raj healing hands, Tapovan, opposite peeple tree hotel, saraye, Laxman Jhula, Uttarakhand 249192";
    ...
    <section id="contact" className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <div className="mb-8">
              <h2 className="text-teal-600 font-bold uppercase tracking-widest text-sm mb-3">
                Get in Touch
              </h2>
              ...
              <p className="text-lg text-slate-600 font-medium">
                We are conveniently located in Tapovan, Rishikesh. Book an
                appointment or visit us for a consultation.
              </p>
            </div>

            <div className="space-y-6 flex-grow mb-8">
              <div
                className="flex items-start space-x-4 p-4 rounded-2xl hover:bg-teal-50 transition-colors border border-transparent hover:border-teal-100 group cursor-pointer"
                onClick={() => window.open(`tel:+918979375090`)}
              >
              ...
              <div
                className="flex items-start space-x-4 p-4 rounded-2xl hover:bg-blue-50 transition-colors border border-transparent hover:border-blue-100 group cursor-pointer"
                onClick={() =>
                  window.open(`mailto:rajhealinghands01@gmail.com`)
                }
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-slate-500 font-semibold mt-1 flex items-center">
                    Rate us 5 Stars <ExternalLink className="h-3 w-3 ml-1" />
                  </p>
                </div>
                <div className="absolute -right-2 -bottom-4 text-9xl font-black text-slate-50 opacity-50 rotate-12 select-none group-hover:scale-110 transition-transform">
                  G
                </div>
              </div>

              <div
                className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200 relative overflow-hidden group cursor-pointer"
                onClick={() =>
                  document
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="text-xs text-teal-600 font-semibold mt-1 flex items-center">
                    Explore Treatments <ArrowRight className="h-3 w-3 ml-1" />
                  </p>
                </div>
