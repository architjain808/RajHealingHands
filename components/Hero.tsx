...
import img from "../assets/big_image.png";
...
const Hero: React.FC = () => {
  return (
    <section
      id="home"
      className="min-h-screen pt-20 flex items-center relative overflow-hidden bg-gradient-to-b from-teal-50 via-white to-blue-50"
    >
      {/* Decorative Blobs */}
      <MotionDiv
        animate={{
